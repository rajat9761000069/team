...
<div class="jumbotron text-center">
  ...
  <a href="registration.php"><button class="btnm btn-success" style="width="10%">Registration to Log In</button></a>
...
<form action="cont.php?login " method="POST">
    <div class="form-group">
      <label for="user">Email:</label>
      <input type="text" class="form-control"  placeholder="Enter user name" name="email">
    </div>
    <div class="form-group">
