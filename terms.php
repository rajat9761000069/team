...
<h2 style="font-style:oblique;">Kindly Check the Box if you understand the term</h2>
<?php
...
{
$row=$r['terms'];
echo "<li><h4>$row</h4></li>";
}
echo "</ul>";
echo "
</br>
<p align='right'>
<a href='loan.php?id=$name&id1=$id1'><button type='button' class='btn btn-success'>I agree	</button></a>
<a href='home.php' ><button type='button' class='btn btn-warning'>I don't agree</button></a>
</p> ";
?>
