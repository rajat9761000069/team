...
$query= "select * from  loan where loan_type='$id1'";
...
<div style='width: 100%;
  ...
  <div class= style='width: 100%;
     height: 100px;'> ";
   echo "<table class='table table-striped table-dark'><thead><tr><th>Bank Name</th><th>Interest</th><th>Rate</th><th>Max Loan</th><th>Tenure</th><th>Quote</th></thead></tr>
   <td>
      <a href='bankinfo.php?name=$bank_name'><img src='images/$bank_image' width='107px' height='130px'/></a>
	 
	   </td>
     <td>$interest</td><td>$rate</td><td>$loan</td><td>$tenure</td><td><a href='$id?id=$id&id1=$id1&id2=$bank_name'><button class='btn btn-success' style='width:100%;'>Get Quote</button></a></td></tr></table>";
 echo "
  </div>
</div   >
</div>
