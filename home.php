  ...
  <div class="row slideanim">
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <h1>Our Main Banks</h1>
        </div>
        <div class="panel-body">
          <p><strong>SBI</strong> Bank</p>
          <p><strong>PNB</strong> Bank</p>
          <p><strong>HDFC</strong> Bank</p>
          <p><strong>ICICI</strong> Bank</p>
          <p><strong>UNION </strong> Bank</p>
        </div>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Sai Properties</strong> </p>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Bajaj </strong> Insurance</p>
          <p><strong>Reliance</strong>Insurance</p>
          <p><strong>ICICI</strong> Insurance </p>
          <p><strong>UNO</strong> Insurance </p>
          <p><strong>SAI</strong> Insurance</p>
        </div>
        <div class="panel-footer">
