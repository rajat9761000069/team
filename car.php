...
<!--  navbar end-->
                    ...
                    <fieldset>
                        <div class="form-top">
                            <div class="form-top-left">
								...
								<h3>Applied for <?php echo "$id2";?> CL in last 3 Months?</h3>
                            </div>
                        </div>
                        <div class="form-bottom">
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
									...
									<label >
								<img src="images/yes.jpg"><input type="radio" class="form-control" name="c" value="yes"  required="required"></label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
								<label>
                                  <img src="images/no.jpg">  <input type="radio" class="form-control" name="c" value="no" required="required" ></label>
                                </div>
                            </div>
                        ...
                        <div class="form-bottom">
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
									...
									<label >
									<input type="radio" class="form-control" name="c1" value="yes" id="y" required="required"> less than 45 days</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
								<label>
                                   <input type="radio" class="form-control" name="c1" value="no" required="required" > more than 45 days</label>
                                </div>
                            </div>
                        ...
                        <div class="form-bottom">
                            <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
									...
									<label >
									<input type="radio" class="form-control" name="c2" value="yes"  required="required">personal</label>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
								<label>
                                   <input type="radio" class="form-control" name="c2" value="no" required="required" > commercial</label>
                                </div>
                            </div>
                           <button type="button" class="btn btn-previous">Previous</button>
   ...
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c3" id="c3"  required="required"></label>
      </div>
   ...
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c4" id="c4"  required="required"></label>
      </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c5"   id="c5" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c6"   id="c6" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
       </div>
        </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c7"  id="c7" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
       </div>
        </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c9"  id="c9" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c10" id="c10"  required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c11"  id="c11" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c12"  id="c12" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
        ...
        <button type="button" class="btn btn-previous">Previous</button>                    
      <button type="button" class="btn btn-next12">Next</button>
       </div>
       </fieldset>
   ...
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c13"  id="c13" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
        ...
        <button type="button" class="btn btn-previous">Previous</button>                    
      <button type="button" class="btn btn-next13">Next</button>
       </div>
       </fieldset>		
   ...
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="c14"  id="c14"  required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
