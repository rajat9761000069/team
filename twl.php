 ...
 <div class="col-md-12 form-box">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="radio" class="form-control" name="tw" value="yes"  required="required"> male</label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
		<label>
        <input type="radio" class="form-control" name="tw" value="no" required="required" > female</label>
       </div>
        </div>
