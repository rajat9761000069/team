...
<!--  navbar end-->
   ...
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd1" id="fd1"  required="required"></label>
      </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd2"   id="fd2" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd3"   id="fd3" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
       </div>
        </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd4"  id="fd4" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
       </div>
        </div>
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd5" id="fd5"  required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<h3>What is your Resident Status?</h3>
        </div>
          </div>
           <div class="form-bottom">
       <div class="row">
	...
	<label >
	<input type="text" class="form-control" name="fd6"  id="fd6" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
  ...
  <fieldset>
   <div class="form-top">
	...
	<label >
	<input type="text" class="form-control" name="fd7"  id="fd7" required="required"></label>
      </div>
       <div class="form-group col-md-6 col-sm-6">
