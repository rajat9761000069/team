...
<div class="jumbotron text-center">
  ...
  <a href="login.php"><button class="btnm btn-success" style="width="10%">Log In</button></a>
...
<form action="cont.php?registration " method="POST">
	...
	<div class="form-group">
      <label for="user phone no-">User phone no-:</label>
      <input type="text" class="form-control"  placeholder="Enter user phone" name="phone">
    </div>
	<div class="form-group">
   ...
   <button type="submit" class="btn btn-default" name="registration">Log In</button>
  </form>
</div>
